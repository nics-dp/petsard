...
from petsard.evaluator.mlutility import (
    MetricRegistry,
    MLUtility,
    MLUtilityConfig,
    TaskType,
...
class TestMetricRegistry(unittest.TestCase):
    ...
    def test_default_metrics(self):
        ...
        self.assertIn("rmse", reg_metrics)  # Changed from 'mse' to 'rmse'
...
class TestMLUtilityConfig(unittest.TestCase):
    ...
    def test_experiment_design_validation(self):
        ...
        self.assertIn("Unsupported experiment design", str(context.exception))
    ...
    def test_resampling_validation(self):
        ...
        with self.assertRaises(Exception) as context:
            MLUtilityConfig(**config_dict)
        self.assertIn("Unsupported resampling method", str(context.exception))
